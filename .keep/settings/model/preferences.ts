...
import { DEFAULT_DAILY_GOAL } from '@app/shared/config/constants'
import {
  DEFAULT_SWIPE,
...
} from '@app/shared/config/flashcard-swipe'
import {
...
export type { SwipePreferences } from '@app/shared/config/swipe'
export type { SelectToolbarPreferences } from '@app/shared/config/select-toolbar'
export type { FlashcardSwipeConfig, FlashcardSwipeByMode } from '@app/shared/config/flashcard-swipe'
