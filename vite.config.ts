...
// (public/manifest.webmanifest, linked in index.html), and the iOS launch screens + icons are
// generated by pwa-asset-generator (`npm run generate:pwa-assets`) into public/pwa-assets/.
  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // The iOS launch images are large and iOS caches them itself at install, so keep them
        // out of the runtime precache (the small PWA/apple icons stay in).
        globIgnores: ['**/pwa-assets/apple-splash-*.png'],
