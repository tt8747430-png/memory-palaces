 ...
 *
 * Bottom sheets lift themselves over the keyboard via Vaul's `repositionInputs`; this hook is
 * what keeps full-page surfaces (editors, forms) from sliding. Mount once, high in the tree.
 */
