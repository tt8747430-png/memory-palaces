export const bibleMessages = {
  ...
  sort: {
    canon: 'Biblical order',
    genre: 'By kind of book',
    oldTestament: 'Old Testament',
    newTestament: 'New Testament',
  ...
  developerHint:
    'Publishing and diagnostic tools, shown because Developer mode is on. The Bible library is shared by every account.',
  developerOff:
  ...
  features: {
    ...
    library: {
      label: 'Verse library',
      description: 'Fill a picked passage in from the published text, offline',
    },
    chapterDecks: {
      label: 'Chapter decks',
  ...
  publishTitle: 'Publish text',
  libraryEmpty: 'No Bible text yet. Add text from your cards to publish it.',
