        ...
        {books.map((book) => (
          <li key={book.name}>
            <button
              ...
              className="w-full rounded-control bg-secondary/40 px-4 py-3 text-left text-body font-semibold text-heading transition-transform duration-150 ease-out active:scale-[0.99] motion-reduce:transition-none"
            >
              {book.name}
            </button>
          </li>
