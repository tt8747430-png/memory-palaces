...
import { NOTIFICATION_REPOSITORY, NotificationStore } from '../data/notification-store'
...
function startedStore(seed: AppNotification[] = []) {
  TestBed.configureTestingModule({
    providers: [
      { provide: NOTIFICATION_REPOSITORY, useValue: new InMemoryRepository<AppNotification>(seed) },
    ],
  })
