...
interface CardLike { front: string; back: string; hint?: string }
...
export function cardsToCsv(cards: readonly CardLike[]): string {
...
export function questionsToCsv(questions: readonly QuestionLike[]): string {
...
export function cardsToAnkiTsv(cards: readonly CardLike[]): string {
