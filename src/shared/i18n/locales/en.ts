...
export const en = {
  ...
  study: {
    ...
    allCaughtUpHint: 'Nothing is due right now. Come back later, or study the whole deck to get ahead.',
    ...
    swipeActionsHint: 'Choose what a fling in each direction does. Set a direction to Off to disable it.',
    swipeUp: 'Swipe up',
    ...
    restartFlashcards: 'Restart flashcards',
    finish: 'Finish',
    quickActions: 'Quick actions',
