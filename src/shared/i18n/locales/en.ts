...
export const en = {
  ...
  study: {
    ...
    modeBlur: 'Blur',
    modeWords: 'Rebuild',
    modeFlipHint: 'Tap the card to flip it, then grade yourself.',
    modeTypeHint: 'Type the answer — every word is checked as you go.',
    modeInitialsHint: 'Each word shrinks to its first letter; tap one to peek.',
    modeBlurHint: 'Hide words behind blanks until you can recite them.',
    modeWordsHint: 'Put the scrambled words back in the right order.',
    modeGroupFlashcard: 'Flashcard',
    modeGroupRecall: 'Recall practice',
    ...
    typeFeedbackHint: 'Each word turns green when it’s right.',
    typeFull: 'Full text',
    typeInitialsOnly: 'Initials',
    typeAid: 'What you type',
    initialsPlaceholder: 'Type the first letter of each word…',
    initialsFeedbackHint: 'Each correct letter reveals its word.',
    wrongLetter: 'Not “{{letter}}”',
    wordPerfect: 'Word-perfect',
    revealWord: 'Reveal “{{word}}”',
    hideWords: 'Hide words',
    showAllWords: 'Show all',
    blurHint: 'Recite the hidden words — tap a blank to peek.',
    rebuildHint: 'Tap the words back in order.',
