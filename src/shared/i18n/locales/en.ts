...
export const en = {
  ...
  roomSettings: {
    ...
    back: 'Back',
    notFound: 'That room could not be found.',
    editDetails: 'Edit room details',
    editDetailsHint: 'Name & description',
    manage: 'Manage',
    duplicate: 'Duplicate room',
    duplicateHint: 'Copy the room and its cards as fresh material',
    markKnown: 'Mark all as known',
    markKnownHint: 'Move every card in this room to mastered',
    resetProgress: 'Reset progress',
  ...
  loci: {
    ...
    transfer: {
      ...
      importSubtitle: 'Bring cards into this room.',
      exportTitle: 'Export cards',
      exportSubtitle: 'Save or back up your cards.',
      importGroup: 'Import',
      exportGroup: 'Export',
      importMindscape: 'Mindscape import',
      importMindscapeSub: 'A .json backup — restores everything',
      ...
      exportJson: 'Card backup',
      exportJsonSub: 'All cards, with hints, as .json',
    ...
    paste: {
      title: 'Paste notes',
      kindLabel: 'What are you pasting?',
      kindNotes: 'Notes',
      kindNotesSub: 'Front and back pairs',
      kindBible: 'Bible',
      kindBibleSub: 'Verses, grouped by chapter',
      dataLabel: 'Paste your cards',
      notesPlaceholder: 'Front side 1, Back side 1\nFront side 2, Back side 2\nFront side 3, Back side 3',
      biblePlaceholder: '3 John 1\n(1:1) The elder, to the beloved Gaius…\n(1:2) Beloved, I pray that all may go well…',
      bibleHintTitle: 'Bible mode',
      bibleHint: 'Paste a chapter — a “Book Chapter” header opens it, and each (chapter:verse) line becomes one card.',
      ...
      create: 'Create',
      empty: 'Paste some text to see cards here.',
    },
    review: {
      title: 'Review cards',
  ...
  questions: {
    ...
    transfer: {
      ...
      exportSubtitle: 'Save this room’s questions.',
      importFile: 'Import a file',
      importFileSub: 'A CSV or JSON with questions',
      exportJson: 'Questions backup',
      exportJsonSub: 'All questions as .json',
