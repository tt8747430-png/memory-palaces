...
export const en = {
  ...
  practice: {
    ...
    wordsSub: 'Put the answer back in order',
    match: 'Match',
  ...
  study: {
    ...
    modeBlur: 'Blur',
    modeWords: 'Rebuild',
    modeFlipHint: 'Tap the card to flip between the two sides.',
    modeTypeHint: 'Type the answer — each word turns green when it’s right.',
    modeInitialsHint: 'See only the first letter of each word, then reveal.',
    modeBlurHint: 'The answer starts blurred; tap a word once you recall it.',
    ...
    blurHint: 'Tap each word once you’ve recalled it.',
