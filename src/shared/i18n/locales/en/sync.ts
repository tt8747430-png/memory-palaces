export const sync = {
  ...
  settings: {
    ...
    account: 'Synchronising as {{name}}',
    syncNow: 'Synchronise now',
    syncNowOffline: 'Reconnect to synchronise.',
    waiting: 'Waiting on this device',
    waitingHint: 'Tap a row to see what it holds.',
    nothingWaiting: 'Nothing is waiting — this device is up to date.',
    waitingSheet: '{{table}} waiting to sync',
    recent: 'Recent syncs',
    ...
    checkEverythingBody:
      'Every deck, card and setting is compared with the cloud again and merged. Changes on this device that have not synced yet are kept. It may take a minute.',
