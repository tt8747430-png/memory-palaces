...
export function StackedDragPreview({
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <span
        className="absolute -right-2 -top-2 z-10 grid h-6 min-w-6 place-items-center rounded-full bg-accent px-1.5 text-tiny font-bold tabular-nums text-(--surface) shadow-interactive ring-2 ring-card"
        aria-hidden
      >
        {count}
      </span>
