...
/**
 * The two curves Motion animations use. `Sheet` keeps the iOS sheet curve of its own — a
 * full-height surface travelling further reads wrong on these. Reach for one of these first;
