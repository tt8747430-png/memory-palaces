    ...
    <AuthScreen>
      <div className="pt-2">
        <button
          type="button"
          onClick={onBack}
          className="-ml-1.5 inline-flex min-h-11 items-center gap-1.5 rounded-control px-1.5 text-label font-medium text-heading transition-colors active:bg-primary/4"
        >
