    ...
    >
      {!ready ? (
        ...
        <div className="mt-2 flex flex-col gap-6">
          <section>
            <h2 className="mb-3 px-1 text-title font-bold text-heading">
            ...
            >
              {records.map((record, index) => (
                ...
                >
                  <dt className="text-label font-medium leading-tight text-muted-foreground">
                    {record.label}
                  </dt>
                  <dd className="text-headline font-bold leading-none tabular-nums text-heading">
                    {record.value}
                  </dd>
                </div>
              ))}
          ...
          <section>
            ...
            <p className="mb-4 mt-0.5 px-1 text-label text-muted-foreground">
