  ...
  return (
    ...
    >
      <div className="mt-4 flex flex-col gap-6 pb-28">
        <p className="px-1 text-(length:--p-text-sub) text-muted-foreground">
          ...
          >
            {category.items.map((item) => (
              <details key={item} className="group px-4 py-3">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-3 text-(length:--p-text-sub) font-semibold text-heading">
                ...
                <p className="mt-2 text-(length:--p-text-label) leading-relaxed text-muted-foreground">
        ...
        <div className="rounded-card bg-info-surface p-4">
          ...
          <div className="mt-2 flex flex-col gap-2.5">
            <a
              ...
              className="inline-flex items-center gap-2 text-(length:--p-text-sub) font-semibold text-primary"
            >
