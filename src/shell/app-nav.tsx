...
export function AppNav() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-[max(0.75rem,env(safe-area-inset-bottom))] left-1/2 -translate-x-1/2"
      style={{ zIndex: 'var(--ms-z-nav)' }}
    >
      <div
        aria-hidden
          ...
          return (
            ...
            >
              {isActive ? (
                <motion.span
                  layoutId="navPill"
                  transition={reducedMotion ? instant : navySpring}
                  aria-hidden
              ...
              <span className="relative z-10 flex flex-col items-center gap-1">
                ...
                <span
                  className={cn(
                    'text-[length:var(--ms-text-tiny)] font-medium',
