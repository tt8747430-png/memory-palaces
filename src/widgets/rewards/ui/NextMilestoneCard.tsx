    ...
    >
      <div className="flex items-center gap-3.5">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sub font-bold leading-tight text-heading">
        ...
        <span className="flex shrink-0 items-center gap-0.5 text-sub font-bold tabular-nums text-primary">
          {pct}%
