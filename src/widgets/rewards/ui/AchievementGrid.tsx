          ...
          >
            ...
            <div className="flex flex-col gap-0.5">
              <p
                className={
                  achievement.earned
                    ? 'text-label font-bold leading-tight text-balance text-heading'
                    : 'text-label font-bold leading-tight text-balance text-muted-foreground'
                }
              >
                {title}
              </p>
              <p
                className={
                  achievement.earned
                    ? 'text-tiny font-bold leading-tight text-(--success-foreground)'
                    : 'text-tiny font-semibold leading-tight text-muted-foreground'
                }
              >
                {status}
              </p>
