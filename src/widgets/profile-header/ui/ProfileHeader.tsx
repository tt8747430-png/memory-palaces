...
import { Bell, BellRing, Building2, Camera, Flame, Settings, Zap } from 'lucide-react'
...
export interface ProfileHeaderProps {
  ...
  avatar?: string | null
  /** Raw XP — shown in the headline stat triple. */
  xp: number
...
/** The profile's chrome: one persistent bar carrying the name (left) and the
 * notifications + settings actions (right), over a centered hero that scrolls beneath
 * it — a circular avatar that taps to edit the photo, the @handle · joined line, and a
 * three-stat headline (streak · XP · palaces). The bar is transparent at the top and
 * gains a glass edge as the hero tucks under it. */
